...
public class FlightappAdminController {
	...
	public ResponseEntity<Object> searchFlight(@RequestBody Flightapp flightapp) {
		return service.searchFlight(flightapp);
	}

	@PatchMapping("/airline/inventory/add")
	public ResponseEntity<Object> saveInventory(@RequestHeader("Authorization") String token,
			@RequestBody FlightappUpdate flightapp) {
